...
class Survey:
    """Questionnaire.
    questions variable format = list of objects created from the Question class
    """
...
satisfaction_survey.questions[0].question #'Have you shopped here before?'
satisfaction_survey.questions[0].choices #['Yes', 'No']
satisfaction_survey.questions[2].choices # ['Less than $10,000', '$10,000 or more']
